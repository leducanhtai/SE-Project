...
<body>
 ...
 {{-- Bắt đầu phần nội dung của trang --}}
        ...
        <div class="container mx-auto flex flex-col md:flex-row items-center justify-between py-16 px-6 min-h-[70vh]">
            <div class="hero-text md:w-1/2 mb-10 md:mb-0 text-center md:text-left">
                ...
                <div class="space-x-4">
                    ...
                    <a href="{{ route('dashboard') }}" class="btn-primary bg-orange-500 hover:bg-orange-600 text-white font-bold py-3 px-8 rounded-lg text-lg">
                        Bắt đầu miễn phí
                    </a>
