    ...
    <div class="lg:col-span-2 space-y-6">
        ...
        <section class="bg-db-card-bg p-5 rounded-lg border border-db-card-border shadow-card">
            <div class="flex justify-between items-center mb-4">
                ...
                <a href="#" class="text-xs font-medium text-db-text-link hover:underline flex items-center">
                    <img src="{{asset('images/figma/view-all-icon.svg')}}" class="w-3.5 h-3.5 mr-1" alt="">View all
                </a>
            </div>
        ...
        <section>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                ...
                <div class="{{ $class['bg_color'] }} p-4 rounded-lg border border-db-card-border shadow-card">
                    <div class="flex justify-between items-start mb-3">
                        <img src="{{ $class['thumbnail'] }}" alt="" class="w-10 h-10 rounded-md object-cover">
                        <button class="text-gray-500 hover:text-gray-700"> <img src="{{asset('images/figma/dots-icon.svg')}}" class="w-4 h-4" alt=""></button>
                    </div>
                    <h3 class="text-base font-semibold text-db-text-primary mb-3">{{ $class['title'] }}</h3>
                    <div class="flex justify-between items-center">
                        <img src="{{ $class['participants_icon'] }}" alt="Participants" class="h-5">
                        <img src="{{ $class['progress_icon'] }}" alt="Progress" class="h-7">
                    </div>
                </div>
                @endforeach
            </div>
        ...
        <section>
            ...
            <div class="bg-db-card-bg p-4 rounded-lg border border-db-card-border shadow-card flex items-center gap-4">
                <img src="{{ $practiceItem['thumbnail'] }}" alt="" class="w-12 h-12 rounded-md object-cover flex-shrink-0">
                <div class="flex-grow">
                    <h3 class="text-base font-semibold text-db-text-primary">{{ $practiceItem['title'] }}</h3>
                ...
                <div class="flex flex-col items-center text-center text-xs text-db-text-muted flex-shrink-0 ml-auto">
                    <span>{{ $practiceItem['participants'] }}</span>
                    <img src="{{ $practiceItem['progress_icon'] }}" alt="Progress" class="h-7 mt-1">
                </div>
            </div>
        </section>
    </div>
        ...
        <section class="bg-db-card-bg p-5 rounded-lg border border-db-card-border shadow-card">
            ...
            <div class="flex justify-between items-center mb-4">
                <button class="p-1.5 rounded-full bg-gray-200 hover:bg-gray-300 text-db-text-primary">
                    <img src="{{asset('images/figma/arrow-left-icon.svg')}}" class="w-4 h-4" alt="">
                </button>
                ...
                <button class="p-1.5 rounded-full bg-gray-200 hover:bg-gray-300 text-db-text-primary">
                     <img src="{{asset('images/figma/arrow-right-icon.svg')}}" class="w-4 h-4" alt="">
                </button>
            </div>
            <ul class="space-y-2.5">
                @foreach($upcomingEvents as $event)
                <li class="{{ $event['bg_color'] }} p-3 rounded-md text-sm text-db-text-content font-medium flex items-center space-x-2 border border-gray-300">
                    <img src="{{ $event['icon'] }}" alt="" class="w-4 h-4 flex-shrink-0">
